...
import { ChevronDownIcon } from "../../../src/atoms/icons/ChevronDownIcon.tsx";

describe("ChevronDownIcon Tests", () => {
  describe("Outline", () => {
    const html = render(<ChevronDownIcon iconStyle={IconStyleTypes.Outline} />);
  ...
  describe("Solid", () => {
    const html = render(<ChevronDownIcon iconStyle={IconStyleTypes.Solid} />);
  ...
  describe("Mini", () => {
    const html = render(<ChevronDownIcon iconStyle={IconStyleTypes.Mini} />);
