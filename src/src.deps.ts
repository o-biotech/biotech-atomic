...
export * from "https://deno.land/x/fathym_atomic_design_kit@v0.0.60/mod.ts";

import FADKTC from "https://deno.land/x/fathym_atomic_design_kit@v0.0.60/tailwind.components.ts";
