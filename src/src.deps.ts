...
export * from "https://deno.land/x/fathym_atomic_design_kit@v0.0.48/mod.ts";

import FADKTC from "https://deno.land/x/fathym_atomic_design_kit@v0.0.48/tailwind.components.ts";
